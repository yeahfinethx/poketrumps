...
def gameround():
    ...
    while True:
        ...
        except pokestat not in [player1_card]:
            print("Sorry, type one of the following words: id, height, weight.\n")
            continue
        else:
            break
...
# Ugh I can't remember what we did here. Laura? Kharina? Lil help?
def totalrounds():
    global round
